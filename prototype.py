...
while j < 999:
    ...
    result_find_back_button = pyautogui.locateOnScreen('images/back.png', confidence=0.8)
    ...
    if result_find_back_button is not None:
        ...
        time.sleep(1)
        result_find_list_hero = pyautogui.locateOnScreen('images/hero.png', confidence=0.8)
        if result_find_list_hero is not None:
            ...
            time.sleep(0.5)
            result_find_close_button = pyautogui.locateOnScreen('images/close.png', confidence=0.8)
            if result_find_close_button is not None:
                ...
                time.sleep(1)
                result_find_start_button = pyautogui.locateOnScreen('images/start.png', confidence=0.8)
