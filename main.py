...
while j < 999:
    ...
    result_find_back_button = pyautogui.locateOnScreen(
        'images/back.png', confidence=0.8)
    print(result_find_back_button)
    if result_find_back_button is not None:
        ...
        time.sleep(1)
        result_find_list_hero = pyautogui.locateOnScreen(
            'images/hero.png', confidence=0.8)
        if result_find_list_hero is not None:
            ...
            time.sleep(1)
            # while i <= 5:
            #     result_click_btn_work = pyautogui.locateOnScreen('images/work.png', confidence=0.9)
            ...
            #     i += 1
            #     time.sleep(0.5)
            result_click_work_all = pyautogui.locateOnScreen(
                'images/all.png', confidence=0.9)
            if result_click_work_all is not None:
                x, y = pyautogui.center(result_click_work_all)
                time.sleep(1)
                pyautogui.click(x, y)
                time.sleep(1)
                pyautogui.click(x, y)
            ...
            time.sleep(0.5)
            result_find_close_button = pyautogui.locateOnScreen(
                'images/close.png', confidence=0.8)
            if result_find_close_button is not None:
                ...
                time.sleep(1)
                result_find_start_button = pyautogui.locateOnScreen(
                    'images/start.png', confidence=0.8)
